...
def can_double_down(card_one, card_two):
    ...
    return value_of_card(card_one) + value_of_card(card_two) == 9 or value_of_card(card_one) + value_of_card(card_two) == 10 or value_of_card(card_one) + value_of_card(card_two) == 11
